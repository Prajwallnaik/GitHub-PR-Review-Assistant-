"""Tests for the OpenRouter AI service (mocked)."""
...
@patch("app.services.ai.openrouter_service.OpenAI")
def test_review_parses_json(mock_openai_class):
    """Test that the service correctly parses the AI JSON response."""
    ...
    service = OpenRouterService(api_key="fake-key")
